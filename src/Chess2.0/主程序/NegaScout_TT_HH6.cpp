// NegaScout_TT_HH.cpp: implementation of the CNegaScout_TT_HH6 class.
//
//////////////////////////////////////////////////////////////////////
...
CNegaScout_TT_HH6::CNegaScout_TT_HH6()
{
...
CNegaScout_TT_HH6::SearchAGoodMove(BYTE byChessBoard[][9])
{
...
void CNegaScout_TT_HH6::NegaScout(int iDepth, int iAlpha, int iBeta)
{
	int iCount;
	BYTE byChess;
	int a,b;
...
int CNegaScout_TT_HH6::SubNegaScout(int iDepth, int iAlpha, int iBeta)
{
	int iCount;
	BYTE byChess;
	int a,b,t;
